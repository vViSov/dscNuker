...
SPAM_CHANNEL = ["MAMO JAK TO", "TATO ROZJEBALI SERWER", "NO NIE", "TO MOJE LINKI", "CHUJ MI W DUPE",
...
SPAM_MESSAGE = ["Error 404, nie wykryto systemu! @everyone discord.gg/streambase"]
